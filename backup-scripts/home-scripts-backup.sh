...
rclone copy -P ~/Scripts/ pcld:ToadArms-rClone-Backups/Scripts &>> "/backupLogs/scriptsBackup-log_$(date +%Y%m%d_%H%M%S).txt"		#/backupLogs/scripts-backup-log.txt
echo "log saved to /backupLogs/"
